...
print('The bool() function allows you to evaluate any value, and give you True or False in return, depending on the value:')
...
print('''\One more value, or object in this case,
